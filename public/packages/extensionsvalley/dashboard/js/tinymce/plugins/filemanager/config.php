...
$base_url = "//" . $_SERVER['SERVER_NAME']; //url base of site if you want only relative url leave empty
$upload_dir = '/packages/extensionsvalley/dashboard/tinymce_files/'; // path from base_url to upload base dir
$current_path = '../../../../tinymce_files/';  // relative path from filemanager folder to upload files folder
