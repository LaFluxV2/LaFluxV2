...
jQuery(document).ready(function () {
    jQuery('.js-permission-role').on('change', function () {
        var current_user_group = jQuery('#current_user_group').val();
...
jQuery(document).ready(function () {
    jQuery('.js-firm-change').on('change', function () {
        var current_user_group = jQuery('#current_user_group').val();
        var role_id = jQuery('#role_id').val();
        var firm_id = jQuery('#firm_id').val()
        if (current_user_group == 1 && role_id != 1) {
            var firm_id = jQuery('#firm_id').val()
            if (firm_id == 0) {
        ...
        else if (current_user_group == 2) {
            var firm_id = jQuery('#current_firm_id').val();
        }
        else {
        }
        document.location.href = "aclmanager?id=" + jQuery('.js-permission-role').val();
